...
{
    public class TextNoteTypeConfiguration : IEntityTypeConfiguration<TextNote>
    {
        public void Configure(EntityTypeBuilder<TextNote> builder)
        {
